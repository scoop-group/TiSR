...
function grammar_params(;
    ...
    return (
        ...
        custom_check_legal_after_fit  = custom_check_legal_after_fit,
    )
end
...
function mutation_params(;                     #|-> probabilites for the various mutations (don't need to add up to 1)
    ...
    p_drastic_simplify::Float64       = 2.0,   #|-> remove parameter nodes with small values and simplify accordingly
