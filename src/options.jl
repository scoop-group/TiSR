...
function general_params(;
    ...
    seen_rejection_probability::Float64    = 0.9,                                                               # -> probability to reject an expression, if it is present in the forgetting expression log
    seen_forget_rate::Int64                = 1,                                                                 # -> in the forgetting expression log, how many visits to forget in ~ 5 second interval
    ...
    @assert seen_forget_rate > 0                                  "seen_forget_rate must be larger 0"
    ...
    return (
        ...
        seen_forget_rate                = seen_forget_rate,
        callback                        = callback,
