...
ops, data                = Options(
    ...
    #     parts            = [0.8, 0.1, 0.1],                     # -> how the data should be splitted. The first part is used for fitting, the second is used for early stopping, while (currently) all are used to calculate the fit quality measures for selection.
    # ),
    binops               = (+, -, *, /, pow),
    ...
    #     # population_niching_sigdigits        = 15,
    # ),
);
